  ...
  return (
    <section id="about" className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50">
      <div className="min-h-screen flex flex-col md:flex-row">
        ...
        <div className={`w-full md:w-1/2 relative flex items-center justify-center p-8 transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'
          }`}>
